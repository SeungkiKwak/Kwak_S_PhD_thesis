...
Table 4.1. Criteria used to distinguish food types, based on fatty acid ratios [@Eerkens2005]		

```{r fatty_acid_ratio, results='asis', echo=FALSE}
# read in the CSV file from /data
example_tab <- read.csv("data/fatty_acid_ratio.csv")
...
print(xtable(example_tab, 
             size="footnotesize", 
             caption="Criteria used to distinguish food types, based on fatty acid ratios [@Eerkens2005]", 
...
# read in the CSV file from /data
example_tab <- read.csv("data/biomarkers.csv")
# for details of table formatting, see http://cran.r-project.org/web/packages/xtable/vignettes/xtableGallery.pdf
print(xtable(example_tab, 
             size="footnotesize", 
             caption="Identification of fatty acid by using GC-MS [modified from @Stear2008]", 
             label="biomarkers"),
      include.rownames=FALSE,
      booktabs = TRUE,
      floating = FALSE, 
...
# read in the CSV file from /data
example_tab <- read.csv("data/bulk_istope_reference.csv")
# for details of table formatting, see http://cran.r-project.org/web/packages/xtable/vignettes/xtableGallery.pdf
print(xtable(example_tab, 
             size="footnotesize", 
             caption="The ranges of bulk $\delta$^13^C values of natural materials [modified from @Mukherjee2004]", 
