...
```{r fatty_acid_ratio, results='asis', echo=FALSE}
# read in the CSV file from /data
example_tab <- read.csv("data/fatty_acid_ratio.csv", check.names = FALSE)
# for details of table formatting, see 
# http://cran.r-project.org/web/packages/xtable/vignettes/xtableGallery.pdf
my_table <- xtable(example_tab, 
             size="footnotesize", 
             caption="Criteria used to distinguish food types, based on fatty acid ratios (Eerkens 2005)", 
             label="fatty_acid_ratio")
# set column widths
#align(my_table) <-  "p{2cm}p{2cm}p{2cm}p{2cm}p{2cm}p{2cm}p{2cm}p{2cm}"
print(my_table, include.rownames=FALSE,
      booktabs = TRUE,
      floating = FALSE, 
...
```{r biomarkers, results='asis', echo=FALSE}
# read in the CSV file from /data
example_tab <- read.csv("data/biomarkers.csv", check.names = FALSE)
# for details of table formatting, see 
# http://cran.r-project.org/web/packages/xtable/vignettes/xtableGallery.pdf
my_table <- xtable(example_tab, 
             size="footnotesize", 
             ...
             label="biomarkers")
# set column widths
#align(my_table) <-  "p{1cm}p{3cm}p{8cm}p{3cm}"
print(my_table, include.rownames=FALSE,
      booktabs = TRUE,
      floating = FALSE, 
      tabular.environment='longtable', 
