...
![(a): "$L\ddot{u}$" shape and (b): "$T\bar{u}$" shape house pits excavated from the Eupha-Ri site. The description of the house shape is based on the Chinese characters "Lu (e)" and "Tu (e8)" \label{EUPhouse}](figures/EUPhouse.jpg) 
