...
![The density distribution of radiocarbon dates from the Kimpo-Yangchon site, using the R package BChron  [dates were calibrated using 'intcal13' calibration curve, cf. @Reimer2013] \label{km_radio}](figures/km_radio.jpeg)
...
![The site plan of the Kimpo-Yangchon site and the location/number of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) [@Kim2013a] \label{km_map}](figures/km_map.jpg)
...
![The density distribution of radiocarbon dates from the Sosa-Dong site, using the R package BChron [dates were calibrated using 'intcal13' calibration curve, cf. @Reimer2013] \label{ss_radio}](figures/ss_radio.jpeg)
...
![The site plan of the Sosa-Dong site and the location of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) [@Kim2008] \label{ss_map}](figures/ss_map.jpg)
...
![The density distribution of radiocarbon dates from the Songguk-Ri site, using the R package BChron  [dates were calibrated using 'intcal13' calibration curve, cf. @Reimer2013] \label{sg_radio}](figures/sg_radio.jpeg)
...
![The site plan of the Songguk-Ri site and the location of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) [@Kim2013] \label{sg_map}](figures/sg_map.jpg)
...
![The density distribution of radiocarbon dates from the Eupha-Ri site, using the R package BChron  [dates were calibrated using 'intcal13' calibration curve, cf. @Reimer2013] \label{ep_radio}](figures/ep_radio.jpeg)
...
![The site plan of the Eupha-Ri site and the location of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) [@Wang2013] \label{eup_map}](figures/eup_map.jpg)
