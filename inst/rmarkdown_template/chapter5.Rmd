...
![The density distribution of radiocarbon dates from the Kimpo-Yangchon site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{km_radio}](figures/km_radio.jpeg)
...
![The density distribution of radiocarbon dates from the Sosa-Dong site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{ss_radio}](figures/ss_radio.jpeg)
...
![The density distribution of radiocarbon dates from the Songguk-Ri site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{sg_radio}](figures/sg_radio.jpeg)
...
![The density distribution of radiocarbon dates from the Eupha-Ri site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{ep_radio}](figures/ep_radio.jpeg)
...
![The site plan of the Eupha-Ri site and the location of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) \label{eup_map}](figures/eup_map.jpg)
