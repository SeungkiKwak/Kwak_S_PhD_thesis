...
![The density distribution of radiocarbon dates from the Kimpo-Yangchon site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{km_radio}](figures/km_radio.jpg)
...
For the luminescence dating two samples were collected. Both of the samples were collected from the house that has not been dated (Table \ref{tab:sampling_LM_KM}, Figure \ref{km_map}).
...
Table \ref{tab:LM_KM} shows the results of the luminescence dating. Overall, the dates match with the main occupation period of the Kimpo-Yangchon site estimated by the radiocarbon dates.
...
U3045   & 0.3       & 10.7               & 5.227±0.486       & 13.625±3.55  & 12.819±0.296 & 11.141±0.429 & 740±160       \\
U3046   & 0.3       & 15.1               & 6.880±0.579       & 10.792±2.031 & 11.775±0.389 & 10.16±0.445  & 740±180 (OSL) \\ \bottomrule
\end{tabular}
...
![The density distribution of radiocarbon dates from the Sosa-Dong site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{ss_radio}](figures/ss_radio.jpg)
...
![The site plan of the Sosa-Dong site and the location of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) \label{ss_map}](figures/ss_map.jpg)

\subsubsection{Luminescence dating}

As at the Kimpo-Yangchon site, two samples were collected for the luminescence dating. One of the two samples was collected from a house which had been dated by the radiocarbon dating, and the other from another which has not been (Table \ref{tab:sampling_LM_SS}, Figure \ref{ss_map}). 
...
Table \ref{tab:LM_SS} shows the results of the luminescence dating. The dates were slightly younger than the main occupation period of the Sosa-Dong site estimated by the radiocarbon dates. 
...
\toprule
Lab. No & Depth (m) & Water Content (\%) & Dose rate* (Gy/ka) & TL (De)       & OSL (De)      & IRSL (De)     & Age (BC)            \\ \midrule
U3042   & 0.3       & 18.4               & 7.872±0.475       & 20.97±1.59   & 14.487±0.43  & 13.194±0.307 & 650±140 \\
U3043   & 0.3       & 19.7               & 6.664±0.40        & 13.999±1.469 & 11.958±0.229 & 14.18±0.591  & 390±110 \\ \bottomrule
\end{tabular}
...
![The density distribution of radiocarbon dates from the Songguk-Ri site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{sg_radio}](figures/sg_radio.jpg)
...
![The site plan of the Songguk-Ri site and the location of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) \label{sg_map}](figures/sg_map.jpg)
...
![The density distribution of radiocarbon dates from the Eupha-Ri site, using the R package BChron (dates were calibrated using 'intcal13' calibration curve) \label{ep_radio}](figures/ep_radio.jpg)
...
Thus, a total of 25 samples were collected from eight house pits (Table \ref{tab:sampling_OG_EP}, Figure \ref{ep_map}). Though I tried to collect as many samples as I could in the given situation, I have to confess that the eight house pits might not fully represent the entire aspect of the site. If there are available radiocarbon dates from the house pits where the samples were collected, I have indicated in Table \ref{tab:sampling_OG_EP}.  
...
![The site plan of the Eupha-Ri site and the location of samples taken for the radiocarbon dating (R), organic geochemical analyses (O), and luminescence dating (L) \label{ep_map}](figures/ep_map.jpg)


\subsubsection{Luminescence dating}

For the luminescence dating three samples were collected. Among the three samples, one was collected from the house pit that had been dated by the radiocarbon dating, and the other two from those which had not been (Table \ref{tab:sampling_LM_EP}, Figure \ref{ep_map}). 
...
U3039   & 0.3       & 14                 & 6.378±0.429       & 14.67±1.07  & 8.13±0.264  & 14.652±2.537 & 160±120 AD (OSL) \\
U3040   & 0.3       & 13.4               & 5.336±0.562       & 12.3±3.1    & 8.974±0.16  & 10.04±0.214  & 260±110 BC       \\
U3041   & 0.3       & 12.6               & 6.596±0.300       & 7.916±0.598 & 8.578±0.186 & 8.534±0.326  & 530±60 AD        \\ \bottomrule
\end{tabular}
