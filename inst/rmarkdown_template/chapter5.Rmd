...
As at the Kimpo-Yangchon site, two samples were collected for the luminesce dating to see if there would be positive correlations between its results and the published AMS radiocarbon dates [@Kim2008, Table ???]. One of the two samples was collected from a house which had been dated by the radiocarbon dating, and the other from another which has not been (Table \ref{tab:sampling_LM_SS}). 
