...
![The result chromatogram of the GC-MS analysis of one our samples from the Kimpo-Yangchon site (KIM061), using R version 3.2.0. Due to degradation, we usually observe medium- and long-chain saturated fatty acids. 5-α Cholestane was added as an internal standard (IS = 132 ng / microliter) \label{chromatogram1}](figures/chromatogram1.jpg)
...
![The result chromatogram of the GC-MS analysis of one our samples from the Sosa-Dong site (SOS049), using R version 3.2.0. Due to degradation, we usually observe medium- and long-chain saturated fatty acids. 5-α Cholestane was added as an internal standard (IS = 132 ng / microliter) \label{chromatogram2}](figures/chromatogram2.jpg)
