...
\begin{figure}[htbp]
  \centering
  \includegraphics{figures/EUPhouse.jpg}
  \caption{$L\ddot{u}$ shape and (b): $T\bar{u}$ shape house pits excavated from the Eupha-Ri site. The description of the house shape is based on the Chinese characters XX and XX}
  \label{fig:EUPhouse}
\end{figure}
