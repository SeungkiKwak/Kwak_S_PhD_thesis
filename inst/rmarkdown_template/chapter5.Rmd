...
\caption{The results of the AMS radiocarbon dating of the Kimpo-Yangcho site}
\label{tab:radiocarbon_KM}
\end{longtable}

![The density distribution of radiocarbon the dates from the Kimpo-Yangchon site, using the R package BChron  [the dates were calibrated using the 'intcal13' calibration curve, cf. @Reimer2013] \label{km_radio}](figures/km_radio.jpeg)
...
\caption{The samples collected from the Kimpo-Yangchon site for the organic geochemical analysis}
...
![The site plan of the Kimpo-Yangchon site and the location/number of the samples taken for the radiocarbon dating (R), organic geochemical analysis (O), and luminescence dating (L) [@Kim2013a] \label{km_map}](figures/km_map.jpg)
...
![Some of the artifacts uncovered during the excavation of the Kimpo-Yangchon site: semi-lunar shaped knife (upper-left), pots (right; rim-punctuation: upper-right), and arrowheads (down-left) \label{KY-artifacts}](figures/KY-artifacts.jpg)

\subsubsection{Luminescence dating}
For the luminescence dating two samples were collected. Both of the samples were collected from a house which was not dated (Table \ref{tab:sampling_LM_KM}, Figure \ref{km_map}).
...
There are compounds which are only found in certain food groups. Especially, phytanic acid (3,7,11,15-tetramethylhexadecanoic acid) and 4,8,12-TMTD (4,8,12-trimethyltridecanoic acid) are isoprenoid compounds which are mostly found in a particularly high concentration in marine animals [@Evershed2008b, cf. Chapter 4]. Along with thermally produced long-chain $\omega$-(o-alkylphenyl)alkanoic acids, these compounds are indicators of aquatic/marine resources [@Craig2011; @Evershed2008a]. Since the Kimpo-Yangchon site is only 4 kilometers apart from the Han river (Figure \ref{site_locations_zoomin}), it is essential to know whether its dwellers relied on aquatic resources. Among those 20 samples, one sample showed the presence of phytanic acid (KIM061), indicating the possibility that those pots would have been used for processing aquatic resources.  
...
![The density distribution of the radiocarbon dates from the Sosa-Dong site, using the R package BChron [the dates were calibrated using the 'intcal13' calibration curve, cf. @Reimer2013] \label{ss_radio}](figures/ss_radio.jpeg)
...
\caption{The samples collected from the Sosa-Dong site for the organic geochemical analysis}
\label{tab:sampling_OG_SS}
\end{longtable}


![The site plan of the Sosa-Dong site and the location of the samples taken for the radiocarbon dating (R), organic geochemical analysis (O), and luminescence dating (L) [@Kim2008] \label{ss_map}](figures/ss_map.jpg)
...
![The density distribution of radiocarbon dates from the Songguk-Ri site, using the R package BChron  [the dates were calibrated using the 'intcal13' calibration curve, cf. @Reimer2013] \label{sg_radio}](figures/sg_radio.jpeg)
...
\caption{The samples collected from the Songguk-Ri site for the organic geochemical analysis in this thesis}
\label{tab:sampling_OG_SG}
\end{longtable}


![The site plan of the Songguk-Ri site and the location of the samples taken for the radiocarbon dating (R), organic geochemical analysis (O), and luminescence dating (L) [@Kim2013] \label{sg_map}](figures/sg_map.jpg)
...
\end{tabular}
\caption{The results of AMS radiocarbon dating of the Eupha-Ri site}
\label{tab:radiocarbon_EP}
\end{table}
 

![The density distribution of radiocarbon dates from the Eupha-Ri site, using the R package BChron  [the dates were calibrated using the 'intcal13' calibration curve, cf. @Reimer2013] \label{ep_radio}](figures/ep_radio.jpeg)
...
![Some of the artifacts uncovered during the excavation of the Eupha-Ri site (a): the Iron Age style hardened un-patterned pottery, a pot made by the beating method (center, second row) (b): mold for iron casting, net sinker, spindle whorls, iron axes and arrowheads \label{EUPartifact}](figures/EUPartifact.jpg) 
...
\end{tabular}
\caption{The samples collected from the Eupha-Ri site for the organic geochemical analysis in this thesis}
\label{tab:sampling_OG_EP}
\end{table}


![The site plan of the Eupha-Ri site and the location of the samples taken for the radiocarbon dating (R), organic geochemical analysis (O), and luminescence dating (L) [@Wang2013] \label{eup_map}](figures/eup_map.jpg)
...
EUP031     & C16:0, C17:0, C18:0, C20:0, C22:0                                                                               & -26.8          & -26.6          & Pork adipose and/or Fresh water resources                           \\
EUP032     & C14:0, C15:0, C16:0, C16:1, C18:0, C18:2                                                                        & -27            & -28.2          & Ruminant adipose and/or Fresh water resources  and/or  C3 plant oil \\ \bottomrule
